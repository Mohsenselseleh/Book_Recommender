...
#Loading the files
books <- read.csv("C:/Users/Desktop/book/books.csv")
ratings <- read.csv("C:/Users/Desktop/book/ratings.csv")
book_tags <- read.csv("C:/Users/Desktop/book/book_tags.csv")
tags <- read.csv("C:/Users/Desktop/book/tags.csv")
